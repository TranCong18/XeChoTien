			...
			<section className="relative bg-gradient-to-r from-[#b8001c] to-[#1a1a1a] text-white py-20 overflow-hidden mb-0">
				...
				<div className="relative z-10 max-w-4xl mx-auto px-4 text-center flex flex-col items-center">
					...
					<p className="text-2xl md:text-3xl text-red-100 max-w-2xl mx-auto font-medium">
						Đối tác tin cậy trong lĩnh vực dịch vụ, vận tải và cung cấp giải pháp
						cho ngân hàng, doanh nghiệp.
					</p>
				</div>
			</section>
									...
									<div className="w-full md:w-1/2 flex flex-col justify-center">
										...
										{idx === 1 && (
											<div className="mt-6 bg-[#f8f8f8] rounded-xl p-6 shadow text-center">
												...
												<div className="text-gray-700">
													Đầy đủ giấy tờ pháp lý, năng lực cung ứng số
													lượng lớn, đáp ứng mọi yêu cầu đặc thù của
													khách hàng tổ chức tín dụng, doanh nghiệp
													vàng bạc, ngoại tệ...
												</div>
											</div>
										)}
